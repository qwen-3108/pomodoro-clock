      ...
      <div id="timer">
        ...
        <div id="control">
          <button id={START_STOP} className="start-stop" onClick={pomodoro}>
            <Icons name={isCounting? 'stop' :'start'} width='80' height='80' viewBox='0 0 512 512' fill='#3498db' />
          </button>
          <button id={RESET} className="reset" onClick={resetFunc}>
            <Icons name='reset' width='60' height='60' viewBox='0 0 512 512' fill='#3498db'/>
          </button>
        </div>
      </div>
    );
